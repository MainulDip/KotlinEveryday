...
class TasksActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityTasksBinding // activity_tasks.xml
    private val adapter = TasksAdapter() // Adapter = Inject data to view/layout

    private lateinit var viewModel: TasksViewModel // ViewModel = Hold View's State (State holder)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider( // initializing ViewModel State
            this,
        ...
        viewModel.tasksUiModel.observe(this) { tasksUiModel -> // observe to ui change and update view model (state)
